 ...
 *     description: Retourne l'historique des actions de l'agent authentifié (max 200 entrées, paginé). Les actions admin sont masquées.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: limit
 ...
 *   get:
 *     tags: [Fondateur]
 *     summary: Historique d'un agent (admin)
 *     description: Retourne l'historique complet d'un agent, incluant les actions admin.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: agentId
